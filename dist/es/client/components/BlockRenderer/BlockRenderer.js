...
import { getUnstableGalleryGapStyle } from '../../utils/getUnstableGalleryGapStyle.js';
        ...
        if (block.htmlContent && ((_c = block.innerBlocks) === null || _c === void 0 ? void 0 : _c.length)) {
            switch (block.name) {
                case 'core/block':
                    return (React.createElement(BlockRenderer, { key: block.id, blocks: block.innerBlocks }));
                case 'core/gallery': {
                    return (React.createElement("figure", { key: block.id, className: getClasses(block), style: Object.assign(Object.assign({}, getStyles(block)), getUnstableGalleryGapStyle(block.attributes)) },
