...
const TerminalBlock = ({ block }) => {
    ...
    traverse(parsedHTML);
    return (React.createElement(Fragment, null, createReactNodes({ html: parsedHTML, block, allBlocks })));
};
