...
const BlockRendererProvider = ({ renderComponent, customInternalLinkComponent, siteDomain, allBlocks, children, includeTemplate, }) => (React__default["default"].createElement(BlockRendererContext.Provider, { value: {
        renderComponent,
        ...
        blocks.map((block) => {
            ...
            const processNode = (shouldProcessNode) => {
                ...
                if ((_a = block.innerBlocks) === null || _a === void 0 ? void 0 : _a.length) {
                    ...
                    return convertHtmlToReact__default["default"](block.originalContent || block.dynamicContent || '', {
                        transform: (node, i) => {
                            var _a, _b, _c, _d, _e;
...
const RootBlockRenderer = ({ blocks = [] }) => {
    ...
    return includeTemplate ? (React__default["default"].createElement("div", { className: "wp-site-blocks" },
        React__default["default"].createElement(BlockRenderer, { blocks: allBlocks || blocks }))) : (React__default["default"].createElement("div", { className: "wp-site-blocks", style: { paddingTop: 0 } },
