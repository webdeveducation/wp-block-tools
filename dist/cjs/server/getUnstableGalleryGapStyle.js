...
const getUnstableGalleryGapStyle = (attributes) => {
    ...
    if (typeof gap === 'object') {
        if (gap.top) {
            gap.top = parseValue.parseValue(gap.top);
        }
        if (gap.left) {
            gap.left = parseValue.parseValue(gap.left);
        }
    }
    else if (typeof gap === 'string') {
        gap = parseValue.parseValue(gap);
    }
...
exports.getUnstableGalleryGapStyle = getUnstableGalleryGapStyle;
